...
const isBare = (str, allowedProtocols) => !(str.startsWith('/') || str.startsWith('./') || str.startsWith('../') || str.substr(0, 7) === 'http://' || str.substr(0, 8) === 'https://' || allowedProtocols.any((protocol) => str.startsWith(protocol)));
